...
echo "  - If trainer restores the downstream before 3 retries elapse, the next retry"
echo "    succeeds and the message is removed from the queue."
echo "  - If not, the message lands in 'roi.orderhub.dlq.${INITIALS}' as auto-DLQ."
echo
